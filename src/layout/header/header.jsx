      ...
      <div className="flex justify-between pt-2">
        ...
        <div className="flex items-center gap-3 tablet:gap-6">
          <div className="flex items-center gap-4 border-r-[1px] pr-4 tablet:gap-10 tablet:pr-7">
            <Link className="hidden border-b-2 border-transparent text-Gray600 duration-700 hover:border-black hover:text-black dark:text-white hover:dark:border-white tablet:flex tablet:font-semibold desktop:text-[20px]">
              Skill
            </Link>
